...
### UI Interface Tool
  `http://localhost:8002/servers.html`
...
- **Get all servers:**
  `GET http://localhost:8002/api/servers`

- **Filter by RAM (>= 64GB):**
  `GET http://localhost:8002/api/servers?ram_min=16`

- **Filter by Location (Amsterdam) and Price (< 500):**
  `GET http://localhost:8002/api/servers?location=Amsterdam&price_max=100`
